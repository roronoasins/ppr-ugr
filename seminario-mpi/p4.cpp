...
/*
Modificar el programa solución del ejercicio 4.4 Comunicadores para que también se realice
un Scatter de un vector de enteros desde el proceso 1 del comunicador global a todos los procesos impares
de dicho comunicador. Los valores de este vector se escogen arbitrariamente en el proceso 0 (ojo, en el
proceso con rango 0 del comunicador de rangos impares que es el proceso 1 de MPI Comm World), pero su
tamaño debe ser igual número de procesos impares en el comunicador global. El reparto asignará un
elemento de dicho vector a cada proceso impar del comunicador global. Se recomienda usar el
...
int main(int argc, char *argv[]) {
  ...
  cout << "Soy el proceso " << rank << " de " << size << " dentro de MPI_COMM_WORLD,"
          ...
          " aqui he recibido el valor " << b << " y v: " << v_parcial <<"\n"<< endl;
